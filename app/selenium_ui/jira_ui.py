...
"""
def test_1_selenium_custom_action_view_notification_page(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.view_notification_page(jira_webdriver, jira_datasets)
